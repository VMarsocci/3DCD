...
class ResNet18(nn.Module):
    def __init__(self, in_ch, out_ch,
        ...
        self.conv4d = DecBlock_noskip(C[3], C[2])
        self.conv3d = DecBlock_noskip(C[2], C[1])
        self.conv2d = DecBlock_noskip(C[1], C[1])
        self.conv1d = DecBlock_noskip(C[1], C[0]) #, out_ch, bn=False, act=False)
